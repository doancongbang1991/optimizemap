...
function getBlueMarkerIcon(num) {
    return 'https://chart.apis.google.com/chart?chst=d_map_spin&chld=0.666|0|5050FF|10|b|' + num;
}

function getRedMarkerIcon(num) {
    return 'https://chart.apis.google.com/chart?chst=d_map_spin&chld=0.666|0|FF5050|10|b|' + num;
}
